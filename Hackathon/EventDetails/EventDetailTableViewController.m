...
- (void)prepareSportsCategory
{
    ...
    self.eventHeaderView.backgroundColor = [UIColor colorWithRed:231/255.0f green:76.0/255.0f blue:60.0/255.0f alpha:1.0];
...
- (void)prepareEducationCategory
{
    ...
    self.eventHeaderView.backgroundColor = [UIColor colorWithRed:241.0/255.0f green:196/255.0f blue:15/255.0f alpha:1.0];
...
-(void)prepareGreekCategory
{
    ...
    self.eventHeaderView.backgroundColor = [UIColor colorWithRed:52/255.0f green:152/255.0f blue:219/255.0f alpha:1.0];
...
- (void)prepareEntertainmentCategory
{
    ...
    self.eventHeaderView.backgroundColor = [UIColor colorWithRed:46/255.0f green:204/255.0f blue:113/255.0f alpha:1.0];
...
- (void)prepareOtherCategory
{
    ...
    self.eventHeaderView.backgroundColor = [UIColor colorWithRed:155/255.0f green:89/255.0f blue:182/255.0f alpha:1.0];
